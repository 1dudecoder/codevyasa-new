  ...
  return (
    <div>
      ...
      <div className="flex place-content-center place-items-center flex-wrap w-full  mt-10 md:mt-24 ">
        ...
        <div className="flex place-content-center place-items-center bg-bcolor h-32 w-80 text-center relative mb-28 md:mb-32 lg:mb-48   ">
          <img className="absolute bottom-0 h-48 md:h-52 lg:h-64" src={shaifee} alt="geeta-Director Of Business, Americas-image" />
        ...
        <div className="flex place-content-center place-items-center bg-bcolor h-32 w-80 text-center relative mb-28  md:mb-32 lg:mb-48  ">
          <img className="absolute -bottom-14 h-56 md:h-60 lg:h-72" src={Priyanka} alt="geeta-Director Of Business, Americas-image" />
          <div className="absolute -bottom-14 ">
        ...
        <div className="flex place-content-center place-items-center bg-bcolor h-32 w-80 text-center relative mb-28 md:mb-32 lg:mb-48  ">
          <img className="absolute bottom-0 h-40 md:h-48 lg:h-52" src={subham} alt="geeta-Director Of Business, Americas-image" />
          <div className="absolute -bottom-14 ">
        ...
        <div className="flex place-content-center place-items-center bg-bcolor h-32 w-80 text-center relative mb-28 md:mb-32 lg:mb-48 ">
          <img className="absolute bottom-0 h-48 md:h-52 lg:h-60" src={AndyK} alt="geeta-Director Of Business, Americas-image" />
          <div className="absolute -bottom-14 ">
        ...
        <div className="flex place-content-center place-items-center bg-bcolor h-32 w-80 text-center relative mb-28  md:mb-32 lg:mb-48  ">
          <img className="absolute bottom-0 h-48 md:h-52 lg:h-64" src={geeta} alt="geeta-Director Of Business, Americas-image" />
          <div className="absolute -bottom-14 ">
        ...
        <div className="flex place-content-center place-items-center bg-bcolor h-32 w-80 text-center relative mb-28  md:mb-32 lg:mb-48 ">
          <img className="absolute bottom-0 h-48 md:h-52 lg:h-60" src={joy} alt="geeta-Director Of Business, Americas-image" />
          <div className="absolute -bottom-14 ">
    ...
    <div className="flex flex-wrap place-content-center place-items-center">
        <div className="p-4 lg:p-10  flex flex-col place-items-center place-content-center">
            <p>Smart Minds</p>
            <h1 className="border-2 border-bcolor text-4xl mt-2  rounded-full w-fit px-5 py-10">125+</h1>
        </div>

        <div className="p-4 lg:p-10 flex flex-col place-items-center place-content-center">
            <p>Countries</p>
            <h1 className="border-2 border-bcolor text-4xl mt-2  rounded-full w-fit px-8 py-10">12+</h1>
        </div>


        <div className="p-4 lg:p-10 flex flex-col place-items-center place-content-center">
            <p>Happy Customers</p>
            <h1 className="border-2 border-bcolor text-4xl mt-2  rounded-full w-fit px-8 py-10">55+</h1>
        </div>


        <div className="p-4 lg:p-10 flex flex-col place-items-center place-content-center">
            <p>CAGR</p>
            <h1 className="border-2 border-bcolor text-4xl mt-2  rounded-full w-fit px-8 py-10">78%</h1>
        </div>
    </div>
