      ...
      <div className="px-5 sm:px-14 text-center md:text-left  md:flex justify-between place-items-center bg-zinc-100 mt-8 ">
        <div className="text-start my-5 sm:my-14 mx-2 ">
          ...
          <div className="mt-4">
            ...
            <a
              ...
              href="mailto:support@codevyasa.com"
            >
        ...
        <div className=" md:p-5 md:w-1/2">
          <div className=" w-full md:flex lg:flex   md:pt-5 ">
            ...
            />
            {emailerror === true ? (
              <p className="text-left text-red-600 sm:hidden">
          ...
          {emailerror === true ? (
            <p className="text-center ml-44 text-red-600 hidden sm:block">
              Please Enter Valid Email
            </p>
          ) : (
            <p></p>
          ...
          {isError === true ? (
            <p className="text-left text-red-600 hidden sm:block m-1 ml-2">
              Please Enter Valid Number
            </p>
          ) : (
            <p></p>
          ...
          <div className="mt-5 float:none md:float-right  pb-10 ">
            <button onClick={handlesubmit} className="btn w-full px-20 py-2">
              Send
            </button>
          </div>
        </div>
