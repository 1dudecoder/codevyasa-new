        ...
        <div className="w-full bg-fcolor p-10 text-center md:text-left  md:flex md:place-content-between ">
          ...
          <div className="p-2">
            <div className="text-white font-thin">
              ...
              <p><Link to="/services/web-dev">Web-based Application</Link></p>
              <p><Link to="/services/app-dev">Mobile Apps</Link></p>
              <p><Link to="/services/dev-ops">Dev-Ops</Link></p>
              <p><Link to="/services/ui-ux">UI/UX</Link></p>
              <p><Link to="/services/shared-cto">Shared CTO</Link></p>
            </div>
          </div>
          ...
          <div className="p-2">
            <div className="text-white font-thin">
              ...
              <p><Link to="/engineering/mobile">Flutter</Link></p>
              <p><Link to="/engineering/mobile">React Native</Link></p>
              <p>  <Link to="/engineering/ecommerce">VTEX</Link></p>
              <p> <Link to="/engineering/ecommerce">Shopify</Link></p>
              <p><Link to="/engineering/cloud">Cloud Services</Link></p>
              <p><Link to="/services/dev-ops">DevOps</Link></p>
            </div>
          </div>
          ...
          <div className="p-2">
            <div className="text-white font-thin">
              ...
              <p><Link to="/Pricing">Project-Based</Link></p>
              <p><Link to="/Pricing">Virtual Team</Link></p>
              <p><Link to="/Pricing">MVP Pack</Link></p>
            </div>
          </div>
